        ...
        <div class="container">
          <div class="profile-container">
            <div class="profile-sidebar">
              <div class="user-card glass-card tech-border">
                <div class="avatar">
              ...
              <div class="menu-list glass-card tech-border">
                <div
            ...
            <div class="profile-content">
              <div v-if="activeMenu === 'basic'" class="content-section glass-card tech-border">
                <div class="section-header">
                  <h2 class="heading-tech">基本信息</h2>
                ...
                <div v-if="!editMode" class="info-list">
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">{{ Array.isArray(user?.selectedSubjects) ? user.selectedSubjects.join('、') || '-' : '-' }}</span>
                  </div>
                  <div class="info-row">
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">{{ user?.score != null ? Number(user.score).toFixed(2) : '-' }}分</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label">全省位次</span>
                    <span class="info-value">{{ user?.rank != null ? Number(user.rank).toFixed(2) : '-' }}</span>
                  </div>
                </div>
              ...
              <div v-if="activeMenu === 'password'" class="content-section glass-card tech-border">
                <div class="section-header">
                  <h2 class="heading-tech">修改密码</h2>
                </div>
              ...
              <div v-if="activeMenu === 'plans'" class="content-section glass-card tech-border">
                <div class="section-header">
                  <h2 class="heading-tech">我的方案</h2>
              ...
              <div v-if="activeMenu === 'history'" class="content-section glass-card tech-border">
                <div class="section-header">
                  <h2 class="heading-tech">浏览历史</h2>
              ...
              <div v-if="activeMenu === 'settings'" class="content-section glass-card tech-border">
                <div class="section-header">
                  <h2 class="heading-tech">系统设置</h2>
                </div>
              ...
              <div v-if="activeMenu === 'logout'" class="content-section glass-card tech-border">
