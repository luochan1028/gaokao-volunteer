...
Register-ScheduledTask -TaskName "GaokaoStart2" -Action $action -Trigger $trigger -Settings $settings -Principal $principal -Force | Out-Null
Start-ScheduledTask -TaskName "GaokaoStart2"
